...
(library Library_1
	...
	(patternDef "C5SMFRJECT0W0BB2" (originalName "C5SMFRJECT0W0BB2")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.28 1.85) (pt 3.82 1.85) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.82 1.85) (pt 3.82 -1.85) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.82 -1.85) (pt -1.28 -1.85) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.28 -1.85) (pt -1.28 1.85) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "C5SMF-RJE-CT0W0BB2" (originalName "C5SMF-RJE-CT0W0BB2") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		...
		(attr "<Hyperlink>" "")
		(attr "<Component Height>" "8.75")
		(attr "<STEP Filename>" "C5SMF-RJE-CT0W0BB2.stp")
		(attr "<STEP Offsets>" "X=1.27;Y=0;Z=0.44")
