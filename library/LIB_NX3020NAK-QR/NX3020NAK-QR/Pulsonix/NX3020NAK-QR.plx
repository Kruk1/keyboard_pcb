...
//20545900/1857658/2.50/3/2/MOSFET N-Channel
...
(library Library_1
	...
	(symbolDef "NX3020NAK-QR" (originalName "NX3020NAK-QR")
	...
	(compDef "NX3020NAK-QR" (originalName "NX3020NAK-QR") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "NX3020NAK-QR"))
		...
		(attr "Manufacturer_Part_Number" "NX3020NAK-QR")
		(attr "Description" "30 V, N-channel Trench MOSFET")
		(attr "<Hyperlink>" "https://assets.nexperia.com/documents/data-sheet/NX3020NAK.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "NX3020NAK-QR.stp")
